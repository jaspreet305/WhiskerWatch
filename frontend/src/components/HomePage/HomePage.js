      ...
      <div className={"home-page-screen-div"}>
        <div className={"home-page-screen-div-2"}>
          <div className={"home-page-screen-overlap"}>
            ...
            {/*  <img className={"home-page-screen-animal"} src={"/img/dog-1-1.png"} />*/}
            {/*      */}
            {/*</div>*/}
            {/*<div className={"home-page-screen-add-more"}>*/}
            {/*  <img className={"home-page-screen-img-3"} src={"/img/plus_sign.png"} />*/}
            {/*</div>*/}
...
//   const numPetDivs = petPics.length;
//   const remainingPetDivs = numPetDivs < 3 ? Array.from({ length: 3 - numPetDivs - 1 }, (_, i) => (
//       <div key={i} className={"home-page-screen-img-wrapper"}>
//         <img className={"home-page-screen-img-3"} src={"/img/blank-profile.png"} />
//       </div>
//   )) : [];
//
//   const petDivs = [...petPics, ...(numPetDivs < 3 ? [...remainingPetDivs, addPetDiv] : [])];
...
//         <div className={"home-page-screen-welcome"}>
